<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-file-invoice"></i> Détails commande #<?= e($order['id']) ?></h1>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <p><strong>Nom:</strong><br><?= e($order['first_name'] . ' ' . $order['last_name']) ?></p>
                    <p><strong>Email:</strong><br><a href="mailto:<?= e($order['email']) ?>"><?= e($order['email']) ?></a></p>
                    <p><strong>Username:</strong><br>@<?= e($order['username']) ?></p>
                </div>
            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Paiement:</strong><br>
                        ...
                        echo $payment[$order['payment_method']] ?? e($order['payment_method']);
                        ?>
                    </p>
                </div>
            </div>
